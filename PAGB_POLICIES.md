Pakistan Army Green Book is an official Pakistan Army research journal published by Inspector General Training and Evaluation/ Human Resource Development Directorate. Submission of a manuscript to PAGB implies that all authors have read and agreed to its content and that their manuscripts conform to the journal’s policies. PAGB remains neutral regarding jurisdictional claims in published maps and institutional affiliations.  

ISSN (Print): 2709-5134 

**Aims and Objectives**

The primary aims and objectives of the initiative are as follows:

1. Advancement of Research: To enhance and advance research pertaining to Hard core Military Subjects National Security to enhance the development and growth of Armed Forces Officers.
1. Promotion of Scholarly Publishing: To encourage the publication of high-quality exploratory, analytical and empirical research manuscripts that contribute to the field.
1. Encouragement of Diverse Writing: To promote a variety of genres in both creative and research writing, reflecting the multifaceted nature of national security issues and modern warfare.
1. Publication of Contemporary Research: To disseminate new research findings that address contemporary challenges in national security.
1. Provision of a Research Platform: To offer a dedicated platform for researchers to explore pressing national security issues and propose tangible, actionable solutions to the security challenges faced by Pakistan.

**Scope**

1. **Contribution Enhancement.** The PAGB aims to enhance the value of contributions by engaging a wide spectrum of military professionals, academicians, scholars, and thought leaders. We look forward to your forthcoming intellectual discourse aligned with the journal's scope.
1. **Primary Focus Areas.** The PAGB primarily addresses **HARD CORE MILATRY SUBJECTS** and **NATIONAL SECURITY ISSUES**, with particular emphasis on the following areas:
- Military Strategy
...
- National Security Issues
  1. Threat Perceptions regarding National Defense
  1. Terrorism
  1. Extremism and Radicalization
  1. Media and Information Management
  1. Psychological/ Social Media Issues
  1. Regional Conflicts (South Asia, Middle East, Afghanistan, Southeast Asia, Central Asia)
  1. Kashmir Dispute
  1. Afghanistan Issue
  1. Regional Water-Based Conflicts
  1. Economic Security
  1. Climate Change
  1. Any other subject matter that bears implications for the National Security of Pakistan

**PUBLICATION POLICY**

PAGB publication policy follows the Higher Education Commission of Pakistan (HEC) Journals and Publications [Guidelines](https://www.hec.gov.pk/english/services/faculty/journals/Documents/Policies/Research_Journals_and_Publications_Policy.pdf). and the Committee on Publication Ethics (COPE) Guidelines on [Good Publication Practice](https://publicationethics.org/files/u7141/1999pdf13.pdf).
...
PAGB core value of intellectual freedom and independent editorial decisions is based on the Committee on Publication Ethics (COPE) [Code of Conduct](https://publicationethics.org/files/2008%20Code%20of%20Conduct.pdf). The editorial decision-making process is not linked to any commercial interest. Any complaints about editorial decisions are dealt with strictly within the editorial structures of a publication.

**Editorial Procedure**

The submitted manuscripts are treated as per the following procedure:

- Acknowledgment on receipt of the research paper from author(s).
- A preliminary review by the editorial team (rejection or provisional acceptance) according to the scope and policy of the journal, format of the submitted manuscript, and assessment of originality and plagiarism.
- Carrying out blind peer reviews by national and foreign reviewers.
- Improvement/ revision (if necessary) by the author(s) as suggested by the reviewer(s).
- Resubmit to the reviewer(s) if deemed necessary.
- Selection for the publication or rejecting the manuscript as per the reviewers' recommendations.
- Editorial process including final editing, formatting, processing and printing*.*
- Publication of the journal.

**PUBLICATION POLICY**

PAGB’s publication policy adheres strictly to the Higher Education Commission of Pakistan (HEC) Journals [Guidelines](https://www.hec.gov.pk/english/services/faculty/journals/Documents/Policies/Research_Journals_and_Publications_Policy.pdf) and Publications [Guidelines](https://www.hec.gov.pk/english/services/faculty/journals/Documents/Policies/Research_Journals_and_Publications_Policy.pdf), as well as the Committee on Publication Ethics (COPE) Guidelines on [Good Publication Practice](https://publicationethics.org/files/u7141/1999pdf13.pdf).
...
PAGB upholds the core principle of intellectual freedom and maintains independent editorial decision-making in accordance with the COPE [Code of Conduct](https://publicationethics.org/files/2008%20Code%20of%20Conduct.pdf). Editorial decisions are made free from any commercial influence. Any grievances regarding editorial decisions are addressed exclusively within the publication’s editorial framework.
...
![](Aspose.Words.bf2621f0-cd88-4295-a982-28f61ea2910a.001.png)
...
- COPE [Code of Conduct and Best Practice Guidelines for Journal Editor(s)](https://publicationethics.org/files/Code_of_conduct_for_journal_editors.pdf) to follow.
...
- COPE [Ethical Guidelines for Peer Reviewer(s)](https://publicationethics.org/sites/default/files/ethical-guidelines-peer-reviewers-cope.pdf) to follow.
...
All manuscripts must be accompanied by a brief abstract (properly formatted as justified in Italicized text) and keywords, and highlight Research Background, Methodology, Major Finding(s), and Conclusion in brief.

The general guidelines for the authors are appended below:

\-  **Language:**                                      British English\
\-  **Abstract:**                                         150-250 Words\
\-  **Manuscripts Length:**                   5000-6000 Words (approx.)\
\-  **Font and Size:**                                Times New Roman, 12 Font Size\
\-  **Spacing:**                                           1.5\
...
Articles published in PAGB are licensed under an open-access **Creative Commons Attribution-Noncommercial 4.0 International License ([**CC BY-NC 4.0**](https://creativecommons.org/licenses/by-nc/4.0/)).** A research paper published in PAGB may be reused and quoted provided the original version is cited while ensuring that the Author(s) receives proper credit.
...
PAGB is an Open Access Journal, free for everyone to read, download and cite.

**Publication/ Processing Fee**

PAGB does not charge any fee for submitting, processing, and publishing research papers, therefore, no fee waiver policy exists.  

**Subscription**

All issues of PAGB are freely available online but print editions (hard copy) are only available for officers of Pakistan Army).

**Revenue Sources**

PAGB ([Y-category journal](https://hjrs.hec.gov.pk/index.php?r=site%2Fresult&id=1021559#journal_result)) is funded by Pakistan Army and partially funded by the Higher Education Commission of Pakistan (HEC). It also follow  a business model (e.g., advertising of Armed Forces Run Commercial Organizations).
...
**SUBMISSION PROCESS : GUIDELINES FOR SUBMISSION OF RESEARCH ARTICLES**

The complete manuscript submission process is:
...
Select the appropriate section for your submission (e.g., article, review, etc.). Read and agree to the statements in the submission checklist by checking each box. Include any comments for the editor, read the journal’s privacy statement, and then click the Save and Continue button to move to Step 2.

4\. Step 2: Upload submissions
...
The author should make sure that the data provided in author declaration form and metadata is same. Otherwise, the journal has the authority to replace metadata according to author declaration form.
