...
export default function AuthorArticleChat() {
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">Share your thoughts, questions, or files about this article with the editor.</p>
          </div>
        ) : (
          messages.map((message) => (
            <div
              key={message.id}
              className={`flex ${message.sender_role === 'author' ? 'justify-end' : 'justify-start'}`}
            >
