                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <FileText className={`w-4 h-4 ${
                            message.senderRole === 'author' ? 'text-white' : 'text-red-600'
                          }`} />
                          <div>
          ...
          <div className="flex-1">
            <div className="relative">
              <textarea
                ...
                className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-green-500 focus:border-green-500 resize-none"
                rows={1}
