          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg max-w-2xl w-full overflow-hidden">
              <div className="p-6">
                ...
                <div className="mb-4">
                  <label className="block text-sm font-medium text-gray-700 mb-1">Attach Revised File</label>
                  <div className="relative">
                    ...
                    <button
                      type="button"
                      className="w-full px-4 py-3 bg-green-700 text-white font-medium rounded-lg hover:bg-green-800 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors cursor-pointer disabled:bg-gray-400 disabled:cursor-not-allowed"
                      onClick={() => document.getElementById('forward-file-input')?.click()}
                      disabled={sendingForward}
                    >
                      {forwardFile ? forwardFile.name : 'Choose File'}
                    </button>
                  </div>
